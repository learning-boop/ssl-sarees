...
/**
 * Sticky WhatsApp chat button — fixed to the bottom-right corner of
 * every page, above all content. Hidden on admin pages (staff don't
 * need to message themselves).
 */
export default function WhatsAppFloat() {
  ...
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.92 }}
      className="fixed bottom-5 right-5 z-40 w-14 h-14 rounded-full bg-[#25D366] text-white shadow-lg shadow-black/25 flex items-center justify-center"
