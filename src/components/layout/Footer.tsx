    ...
    <footer className="bg-foreground text-white pt-16 pb-6" data-testid="footer">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          {/* Brand */}
          <div>
            {/* Logo on a soft ivory card so the green/gold artwork stays
                visible against the dark footer background */}
            <div className="inline-block bg-ivory rounded-2xl p-3 mb-5">
              <img
                src="/assets/ssl-logo.webp"
                alt="SSL Sarees"
        ...
        <div className="border-t border-white/10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <p className="text-xs text-white/40 font-poppins flex items-center gap-1">
            designed <Heart size={10} className="text-gold" /> developed by{" "}
            <a
              href="https://www.creatorstouchglobal.com/"
              target="_blank"
