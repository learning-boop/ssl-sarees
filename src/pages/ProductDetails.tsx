          ...
          <div data-testid="product-info">
            ...
            <motion.a
              ...
              href={`https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent(
                `Hi, I want to buy this product.\n\n*${product.name}*\nPrice: ₹${product.discountedPrice.toLocaleString("en-IN")}\nQuantity: ${qty}\n\nProduct Link: ${window.location.href}`
              )}`}
              target="_blank"
              rel="noopener noreferrer"
              className="w-full flex items-center justify-center gap-2 bg-[#25D366] hover:bg-[#1fb959] text-white font-bold font-poppins py-3.5 rounded-2xl text-sm shadow-md mb-6 transition-colors"
